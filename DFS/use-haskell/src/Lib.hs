...
instance FromBSON InFile
instance ToBSON InFile
...
usersCollection =
  ...
  , User "Neil Diamond" 68 "neil@diamond.hi"
  ]
...
neil :: User
neil = User "Neil Diamond" 68 "neil@diamond.ie"
...
--  runMongo $ insert "files" $ toBSON contents
