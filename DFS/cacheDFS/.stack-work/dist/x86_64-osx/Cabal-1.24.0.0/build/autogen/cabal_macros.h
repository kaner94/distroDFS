...
/* package cacheDFS-0.1.0.0 */
#define VERSION_cacheDFS "0.1.0.0"
#define MIN_VERSION_cacheDFS(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "cacheDFS-0.1.0.0-DRFOXSAzn7fFUwF9Zuy7TU"

#define CURRENT_PACKAGE_KEY "cacheDFS-0.1.0.0-DRFOXSAzn7fFUwF9Zuy7TU"
